...
![img1]({{site.baseurl}}/assets/img/how-to-write-a-macro/img1.png)
...
![img7]({{site.baseurl}}/assets/img/how-to-write-a-macro/img7.png)
...
![img1]({{site.baseurl}}/assets/img/how-to-write-a-macro/img2.png)
...
![img1]({{site.baseurl}}/assets/img/how-to-write-a-macro/img3.png)
...
![img1]({{site.baseurl}}/assets/img/how-to-write-a-macro/img8.png)

Nếu có bất kỳ lỗi hay cảnh báo nào chúng sẽ xuất hiện ỡ cửa sổ này.

![img1]({{site.baseurl}}/assets/img/how-to-write-a-macro/img9.png)
...
![img1]({{site.baseurl}}/assets/img/how-to-write-a-macro/img4.png)

Và đây là kết quả.

![img1]({{site.baseurl}}/assets/img/how-to-write-a-macro/img5.png)

## **Một vài thay đổi**
Vừa rồi chúng ta vừa tạo được một Macro vô cùng đơn giản trong Revit. Sau đây chúng ta sẽ sữ dụng Macro để can thiệp sâu hơn vào mô hình.
### Get All Wall
``` bash
...
![img1]({{site.baseurl}}/assets/img/how-to-write-a-macro/img6.png)
...
Các bạn cũng có thể tìm những Addin hữu dụng trực tiếp trên store của Autodesk. Nếu có bất kỳ thắc mắc gì hãy bình luận bên dưới hoặc liên hệ trực tiếp với mình nhé. Chúc các bạn thành công.
